...
class BaseManager(Generic[ModelType]):
    ...
    @with_transaction_error_handling
    async def save(self, instance: ModelType, commit: Optional[bool] = True):
    ...
    @with_transaction_error_handling
    async def lazy_save(self, instance: ModelType, relations: list[str] | None = None,
                        commit: Optional[bool] = True) -> ModelType:
        self.session.add(instance)
